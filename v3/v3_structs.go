...
type VMRecoveryPointListIntentResponse struct {
	...
	// entities
	Entities []*VMRecoveryPointIntentResource `json:"entities"`
...
type VMRecoveryPointIntentResource struct {
...
type VMRecoveryPointDefStatusResources struct {
	...
	// recoverability
	Recoverability *VMRecoveryPointDefStatusResourcesRecoverability `json:"recoverability,omitempty"`
...
type VMRecoveryPointDefStatusResourcesRecoverability struct {

	// Reason for the recoverability status of the recovery point.
	//
	// Max Length: 256
	Reason string `json:"reason,omitempty"`

	// Recoverability status of the recovery point.
	Status string `json:"status,omitempty"`
}

type VMRecoveryPointIntentResponse struct {
...
type VMRecoveryPointIntentInput struct {
	APIVersion *string   `json:"api_version,omitempty" mapstructure:"api_version,omitempty"`
	Metadata   *Metadata `json:"metadata" mapstructure:"metadata"`
